# TODO — Changelog backlog (archived 2026-03)

**Archived:** Task tracking moved to **`.cursor/plans/`** (one plan file per task). This file is preserved for historical reference only.

Original location: `docs/changelog/TODO.md`. Content below is as of archive date.
...
- Reversible migrations: `scripts/migrations/README.md`, runner `scripts/db/run_migration.py` (list / up / down). New schema changes should be migration pairs in `scripts/migrations/` so they can be reverted like code.
