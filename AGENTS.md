...
**Commands (see .cursor/commands/ and .cursor/pm/):** /verify-local, /verify-production, /system-restart-local, /system-restart-production, /prepare-update, /apply-update, /apply-update-from-local, /confirm-update, /daily-briefing. Workflow: /start-task, /inspect-surface, /implement-plan, /review-change, /promote-knowledge.
