...
Updates all database tables to match MASTER_DB_SCHEMA_REFERENCE.md

This utility script:
1. Parses the schema reference document
2. Compares existing tables with the reference
3. Adds missing columns (preserving all existing data)
4. Handles monitor-specific tables by discovering all instances
...
See scripts/README_db_schema_migration.md for full documentation.
"""
