-- Reverse: cumulative columns back to *_ask_* names (data will reflect prior semantics until re-ingest).
...
BEGIN
  ...
  LOOP
    IF EXISTS (
      ...
      EXECUTE format(
        'ALTER TABLE backtest.%I RENAME COLUMN yes_price_min_15m TO yes_ask_min_15m;',
        r.tablename
      );
    END IF;
    ...
    IF EXISTS (
      ...
      EXECUTE format(
        'ALTER TABLE backtest.%I RENAME COLUMN yes_price_max_15m TO yes_ask_max_15m;',
        r.tablename
      );
    END IF;
    ...
    IF EXISTS (
      ...
      EXECUTE format(
        'ALTER TABLE backtest.%I RENAME COLUMN no_price_min_15m TO no_ask_min_15m;',
        r.tablename
      );
    END IF;
    ...
    IF EXISTS (
      ...
      EXECUTE format(
        'ALTER TABLE backtest.%I RENAME COLUMN no_price_max_15m TO no_ask_max_15m;',
        r.tablename
      );
    END IF;
    ...
    IF EXISTS (
      ...
      EXECUTE format(
        'ALTER TABLE backtest.%I RENAME COLUMN yes_price_range_15m TO yes_ask_range_15m;',
        r.tablename
      );
    END IF;
    ...
    IF EXISTS (
      ...
      EXECUTE format(
        'ALTER TABLE backtest.%I RENAME COLUMN no_price_range_15m TO no_ask_range_15m;',
        r.tablename
      );
    END IF;
  END LOOP;
