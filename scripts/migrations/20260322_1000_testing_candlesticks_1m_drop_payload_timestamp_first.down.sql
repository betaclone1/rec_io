-- Restore prior shape: end_period_ts first, api_payload present (data lost), timestamp column retained.

CREATE TABLE testing.candle_1m_kxbtcd_26mar2116_down (
...
INSERT INTO testing.candle_1m_kxbtcd_26mar2116_down (
    end_period_ts,
    market_ticker,
    price_open_dollars,
    price_high_dollars,
...
ALTER TABLE testing.candle_1m_kxbtcd_26mar2116_down
