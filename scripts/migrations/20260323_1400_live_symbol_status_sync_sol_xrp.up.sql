-- Extend live_symbol_status trigger-driven sync to SOL/XRP, same pattern as BTC/ETH.
...
FOR EACH ROW
EXECUTE FUNCTION live_data.trg_sync_live_symbol_status_from_price_log('SOL');
...
FOR EACH ROW
EXECUTE FUNCTION live_data.trg_sync_live_symbol_status_from_price_log('XRP');
