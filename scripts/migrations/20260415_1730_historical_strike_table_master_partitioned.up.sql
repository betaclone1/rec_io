-- Master strike archive table (single logical table) with monthly partitions.
-- Replaces per-ticker table sprawl in historical_data for strike snapshots.
...
DECLARE
    ...
    i INTEGER;
BEGIN
    -- Create current and next 2 month partitions.
    FOR i IN 0..2 LOOP
