#!/usr/bin/env python3
"""
Improved one-time backfill script to populate bankroll column in trades table
Uses both balance and bankroll_current columns to ensure complete coverage
"""
...
def backfill_trades_bankroll_v2():
    """Backfill bankroll column in trades table using both balance and bankroll_current columns"""
    ...
    try:
        ...
        print("🔍 Starting improved bankroll backfill for trades table...")
