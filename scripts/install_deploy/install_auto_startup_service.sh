...
ExecStart=/opt/rec_io_server/scripts/install_deploy/MASTER_RESTART_WITH_SANITIZATION_CHECK.sh
ExecStop=/bin/true
...
create_startup_wrapper() {
    ...
    cat > /opt/rec_io_server/scripts/install_deploy/auto_startup_wrapper.sh << 'EOF'
#!/bin/bash
...
MASTER_RESTART_SCRIPT="$PROJECT_ROOT/scripts/install_deploy/MASTER_RESTART_WITH_SANITIZATION_CHECK.sh"
...
EOF
    ...
    chmod +x /opt/rec_io_server/scripts/install_deploy/auto_startup_wrapper.sh
...
update_systemd_service() {
    ...
    sed -i 's|ExecStart=/opt/rec_io_server/scripts/install_deploy/MASTER_RESTART_WITH_SANITIZATION_CHECK.sh|ExecStart=/opt/rec_io_server/scripts/install_deploy/auto_startup_wrapper.sh|' /etc/systemd/system/rec-io-auto-startup.service
