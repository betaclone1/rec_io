    ...
    cursor.execute("""
        ...
        BEGIN
            IF NOT EXISTS (
                ...
                AND table_name = 'ndx_price_history' 
                AND column_name = 'volatility'
            ) THEN
                ALTER TABLE historical_data.ndx_price_history ADD COLUMN volatility NUMERIC(15,6);
            END IF;
            ...
            IF NOT EXISTS (
                ...
                ALTER TABLE historical_data.ndx_price_history ADD COLUMN volatility_percentile NUMERIC(5,1);
            END IF;
        END $$;
    """)
