...
3. **Review notes from the update** — Check `.cursor/pm/brain/` (14_context_retention, 13_proposed_tasks, etc.) and any docs updated during/after apply-update. Ensure decisions or outcomes that affect sync are in the repo so dev gets them on pull.
...
- Command doc: `.cursor/pm/CONFIRM_UPDATE_COMMAND.md`
