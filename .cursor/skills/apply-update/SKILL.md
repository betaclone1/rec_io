...
5. **Commands** — Run everything from project root. Use `PYTHONPATH=$(pwd) venv/bin/python` for Python scripts (or the exact command in the checklist). Restarts: `scripts/MASTER_RESTART.sh` or as specified.
