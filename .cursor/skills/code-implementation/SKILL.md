...
2. **Execute steps in order.** For each step: make the minimal code/doc edits required. Follow `.cursor/rules/02-code-change-safety.mdc` (migrations, reversibility, server-agnostic).
