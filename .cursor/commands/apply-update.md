...
2. **Find open entries** — In `docs/changelog/MASTER_CHANGELOG.md`, list every entry whose **Production checklist** has at least one unchecked box (`- [ ]`). Process **newest-first** (by date in the heading).
