...
See .cursor/pm/PREPARE_UPDATE_COMMAND.md for full workflow. Updater: .cursor/rules/updater.mdc. Verify: .cursor/commands/verify-local.md and .cursor/pm/VERIFY_COMMAND.md.