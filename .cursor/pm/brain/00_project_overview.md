...
- **docs/** — Documentation. Changelog in docs/changelog/ (MASTER_CHANGELOG.md, CHANGELOG_AGENT_INSTRUCTIONS.md, TODO.md). Schema: docs/MASTER_DB_SCHEMA_REFERENCE.md. PM memory: .cursor/pm/brain/.
