...
- **.cursor/pm/brain/** — PM memory / persistent context (this folder).
...
- **docs/PROFESSIONAL_DEV_STANDARDS_CHECKLIST.md** — Research-backed checklist (best-practices-researcher): repo structure, tests/unit|integration, CI (pytest, coverage, lint), .env.example, docs layout. Use when improving test layout, env docs, or CI.
