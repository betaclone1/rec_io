...
- **BTC Exp Scalp cutout:** Ladder-notify → full Exp Scalp scan cadence is unchanged. Cutout may share the cheap status helper; do not slow cutout live tick → eval.
